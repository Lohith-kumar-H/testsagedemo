...
package mID631.fID670;
import pom.manageUpdates;
import java.io.File;
...
public class managescr2 extends  AllActions {
	...
	catch(Exception e)
	{
        ...
        try
        {
            actions.EnterData(new manageUpdates(driver).username1,"username1Value");
        ...
        try
        {
            actions.EnterData(new manageUpdates(driver).password5,"asasas");
        ...
        try
        {
            actions.Click(new manageUpdates(driver).buttonobj3);
