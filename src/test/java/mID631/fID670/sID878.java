...
public class managescr1 extends  AllActions {
	...
	catch(Exception e)
	{
        ...
        try
        {
            actions.EnterData(new manageUpdates(driver).username1,"descc");
        ...
        try
        {
            actions.EnterData(new manageUpdates(driver).password5,"fdfddfdf");
