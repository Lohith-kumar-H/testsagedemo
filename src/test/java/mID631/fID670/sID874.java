...
import reuseablePackage.reuseFunction.launchClass;
import java.io.File;
...
public class neScr011 extends  AllActions {
...
int v;
	...
	catch(Exception e)
	{
        ...
        try
        {
            new launchClass(driver).launch("https://the-internet.herokuapp.com/login");
